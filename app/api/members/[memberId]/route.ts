      ...
      data: {
        members: {
          deleteMany: {
            id: params.memberId,
            profileId: {
              not: profile.id, //admin ko thể tự xóa bản thân
            },
          },
        },
      },
...
export async function PATCH(
  ...
  try {
    ...
    /*
    const { searchParams } = new URL("http://example.com/path?param1=value1&param2=value2");
    ...
    */
    ...
    const server = await db.server.update({
      where: {
        id: serverId,
        profileId: profile.id, //xem có phải admin không
      },
      data: {
        members: {
          update: {
